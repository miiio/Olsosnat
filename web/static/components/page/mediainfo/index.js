              ...
              <div class="d-flex justify-content-center">
                <div class="d-flex flex-column justify-content-end ms-2 mt-2">
                  ...
                  <div class="align-self-center align-self-md-start">
                    <a href="${this.media_info.link}" target="_blank" ?hidden=${!this.media_info.tmdbid}><span class="badge badge-outline text-green">Javlib:${this.media_info.rating}</span></a>
